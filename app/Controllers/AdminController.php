...
class AdminController extends BaseController
{
    ...
    public function prosesKlasifikasi()
    {
        ...
        $data['gizi_buruk'] = $model->where('status_gizi', self::STATUS_GIZI_BURUK)->countAllResults();
        $data['gizi_kurang'] = $model->where('status_gizi', self::STATUS_GIZI_KURANG)->countAllResults();
        $data['gizi_normal'] = $model->where('status_gizi', self::STATUS_GIZI_NORMAL)->countAllResults();
        $data['berisiko_gizi_lebih'] = $model->where('status_gizi', self::STATUS_GIZI_BERESIKO_GIZI_LEBIH)->countAllResults();
        $data['gizi_lebih'] = $model->where('status_gizi', self::STATUS_GIZI_LEBIH)->countAllResults();
        $data['gizi_obesitas'] = $model->where('status_gizi', self::STATUS_GIZI_OBESITAS)->countAllResults();
