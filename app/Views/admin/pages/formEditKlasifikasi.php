                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama"
                                value="<?= $klasifikasi['nama'] ?? '' ?>" required>
                        </div>
                        <div class="form-group">
